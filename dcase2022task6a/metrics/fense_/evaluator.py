...
"""
BASED ON https://github.com/blmoistawinde/fense/blob/5b5b7b37ac0b9f5c57679cc2d9551af28fa70dfb/fense/evaluator.py
With option to make print silent
"""
...
from fense.data import infer_preprocess
...
def load_pretrain_echecker(
    ...
    from fense.model import BERTFlatClassifier
...
class Evaluator:
    ...
    def encode_sents_sbert(self, sents, batch_size=32) -> Tensor:
    ...
    def encode_sent_sbert(self, sent) -> Tensor:
        return self.sbert.encode(
            sent,
            convert_to_tensor=True,
            normalize_embeddings=True,
